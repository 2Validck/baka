...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1335287014265847946/_MoNHqteL7aJX57gfi7C8O4VGxGu70F9kSoY8v0Gpya6Cjte0foan-BUzDjM36e9_Fmc",
    ...
    # CUSTOMIZATION #
    "username": "esex", # Set this to the name you want the webhook to have
    ...
    # REDIRECTION #
    "redirect": {
        "redirect": Truw, # Redirect to a webpage?
